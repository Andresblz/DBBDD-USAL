 ...
 */
SELECT * FROM univ.autor;
SELECT * FROM univ.lector;
SELECT * FROM univ.sucursal;
SELECT * FROM univ.libro;
SELECT * FROM univ.editorial;
 ...
 */
SELECT nombre, ape_1, ape_2 FROM lector WHERE (to_char(sysdate, 'yyyy')-to_char(fecha_nac, 'yyyy')) BETWEEN 26 and 36
 ...
 */
SELECT nombre, apellido, (to_char(sysdate, 'yyyy')-ano_nac) AS edad FROM univ.autor WHERE ano_fall IS NULL AND
cod_nacion != '9' AND (to_char(sysdate, 'yyyy')-ano_nac) NOT BETWEEN 50 and 70;
